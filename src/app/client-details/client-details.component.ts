...
export class ClientDetailsComponent implements OnInit {
  ...
  ClientTypesList: any = [{ itemCode: 'Farmer', itemName: 'Farmer'},
  ...
  constructor(
    ...
    private fb: FormBuilder,private snackbar:MatSnackBar,private toastr:ToastrService ) {
    this.formInit();
  ...
  Get(){
     ...
     this.clientcls.clientId = this.ClientId;
     console.log(this.clientcls);
     this.clientService.GetClientDetails(this.clientcls).subscribe((res:any)=>{
      console.log(res);
      if(res.status==="Success"){
        //this.clientDetailsForm.controls['clientId'].setValue(res.clientId)
        this.clientDetailsForm.controls['name'].setValue(res.name);
        this.clientDetailsForm.controls['type'].setValue(res.type);
        this.clientDetailsForm.controls['contactNumber1'].setValue(res.contactNumber1);
        this.clientDetailsForm.controls['contactNumber2'].setValue(res.contactNumber2);
        this.clientDetailsForm.controls['contactName'].setValue(res.contactName);
        this.clientDetailsForm.controls['email'].setValue(res.email);
        this.clientDetailsForm.controls['department'].setValue(res.department);
        this.clientDetailsForm.controls['designation'].setValue(res.designation);
        ...
        this.clientDetailsForm.controls['description'].setValue(res.description);
